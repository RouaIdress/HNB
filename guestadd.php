			      ...
			      ?></a></li>
                    ...
                    if($_SESSION["lang"] == 'Arabic'){
                    	echo "المجموعات  العامة";
                         ...
                         echo "General groups";
			      ?></a></li>
			      	 <li><a href="guestadd.php" style="background-color: #565655;"><?php 
                    if($_SESSION["lang"] == 'Arabic'){
                    	echo "إضافة إعلان";
...
?>
			...
			<!-- account -->
	     	...
	     	<form name="form1" method="post" enctype="multipart/form-data"> 
			    ...
			    <!-- date -->
	    		<div class="control-label text-center" style=" margin-right: 150px;"><h4 style=" color: #ff6666;"><?php 
                    if($_SESSION["lang"] == 'Arabic'){
                    	echo ": التفاصيل";
            ...
            <input type="submit" name="submit"<?php  if($_SESSION['mode']=='night')echo "style='background-color:#1F2B61; border-color:#1F2B61; color:#00FFF9; font-size:25px; margin-right: 50px; margin-top: 12px; ' "; 
                    if($_SESSION["lang"] == 'Arabic'){
