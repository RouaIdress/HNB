			...
			<nav class="navbar-inverse " id="hnav">
			  <div class="container-fluid">
			    ...
			    ?></a></li>
			        ...
			        <li><a href="mygroups.php" style="background-color: #565655;"><?php 
                    if($_SESSION["lang"] == 'Arabic'){
                    	echo "المجموعات";
		   ...
		   style=' ";
            ...
            style='border-top-color: black;'";}echo " >
				...
				<div class='col-lg-6 col-md-6 col-sm-6 col-xs-6'> 
	              ...
	              <input name='$friend->groupName' type='submit'";if($_SESSION["lang"] == 'Arabic'){
                    	echo "value ='عرض'";
                    	                    
                    }else
                         echo "value ='view'";  echo"style='height: 50px;background-color:#FFE4C4;'>
	          </div>
          
               <div class='col-lg-6 col-md-6 col-sm-6 col-xs-6'> 
                <p style='text-align: center;'>
              <input name='$friend->groupID' type='submit'";
              if($_SESSION["lang"] == 'Arabic'){
                    	echo "value ='حذف'";
                    	                    
                    }else
                         echo "value ='Delete'";  echo"style='height: 50px; background-color:#FFE4C4;'>
          </div>
