	 ...
	 $jsonite = file_get_contents("notice.json");
      ...
      foreach ($objites as $friend ) {
       ...
       if(isset($_POST[$sh])){
             ...
             header("Location:guestpostcomment.php");
           else
...
if(isset($_POST['mod'])){
  ...
  $jsonit = file_get_contents("data.json");
  $objite = json_decode($jsonit);
            if(isset($_POST['memd'])){
             foreach ($objite as $frien) {
        if ($frien->userName == $_SESSION['name'] ) {
          $id = $frien->userID;
...
<html<?php 
			      ...
			      <ul class="nav navbar-nav">
			      	<?php 
                    	...
                    	echo "المجموعات العامة";
                         ...
                         echo "General Groups";
                        	 echo "</a></li>
                        	 <li><a href='' style='background-color: #565655;'>".$_SESSION['group']."</a></li>
			      	         <li><a href='guestadd.php'>";
			      	         if($_SESSION['lang'] == 'Arabic'){
                    	echo "اضافة اعلان";
                        	...
                        	<li><a href='accountuser.php'>";
                             ...
                             echo "</a></li>";
			      	        ...
			      	        if($_SESSION['lang'] == 'Arabic'){
                                   ...
                                   echo "My Groups";
                             echo "</a></li>";
			      	        echo"<li><a href='' style='background-color: #565655;'>".$_SESSION['group']."</a></li>";
    ...
    echo "       <li> <button class='btn btn-info btn-lg' type='submit' name='memd'   style='background-color: #160FDE ;'>"; 
                    if($_SESSION["lang"] == 'Arabic'){
                        echo 'مغادرة المجموعة';
...
?>><?php echo $_SESSION['group'];?></div><br>
      ...
      <div class='col-lg-4 col-md-6 col-sm-6 col-xs-12'>
          ...
          echo "
            <hr style='border-top-color:black; '>";
            if( $_SESSION['login'] == 'guest'&&$friend->userName == $_SESSION['nk']){
            echo "
                ...
                <p style='text-align: center;'>
                      ...
                      echo "value= 'حذف'";
                         ...
                         echo "value= 'Delete'";  echo"name='$friend->editID' id='delete' style=' margin-left:30px; width: 100px; height: 40px; background-color:#FFE4C4;'>
                        </div>
                ...
                <p style='text-align: center;'>
                      ...
                      echo "value='تعديل'  ";
                         ...
                         echo "value='edit'"; echo"style=' margin-left:30px; width: 100px; height: 40px; background-color:#FFE4C4;'>
                         </div>
      ...
      <div class='modal-footer'>
        <p style='text-align: center;'>
         ...
         if( $_SESSION['login'] == 'user' && $friend->userName == $_SESSION['name']){
            echo "
                <div class='col-lg-6 col-md-6 col-sm-6 col-xs-6 '> 
                <p style='text-align: center;'>
                        <input type='submit'";
