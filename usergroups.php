			    ...
			    ?></a></li>
                    ...
                    if($_SESSION["lang"] == 'Arabic'){
                    	echo "المجموعات العامة";
                         ...
                         echo "General groups";
			    ?></a></li>
			        <li><a href="usergroups.php" style="background-color: #565655;"><?php 
                    if($_SESSION["lang"] == 'Arabic'){
                    	echo "مجموعاتي";
                ...
                if ($fri->memberName == $_SESSION["name"]&&$fri->groupName == $group ){
					 ...
					 $jsonitem = file_get_contents("groupName.json");
                               ...
                               foreach ($objitems as $friend ) {
                               	if($findmember($friend->groupName) ==true){
				...
				<div class='col-lg-6 col-md-6 col-sm-6 col-xs-6'> 
	              ...
	              if($_SESSION["lang"] == 'Arabic'){
                    	echo "value ='عرض'";
                         ...
                         echo "value ='view' "; echo"style='margin-left:50px; width:100px; height: 50px;background-color:#FFE4C4;'>
	          </div>
